...
What this script does is reformat the csv file, split it into sections that fit on a page, and combine these with the page templates \verb|cards.tex| and \verb|card-frame| to produce front and back pages in pdf format. It then assembles a pdf file for printing.	
