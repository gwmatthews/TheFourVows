...
\vspace*{0.5cm}
	    \begin{quote}
	    	...
	    	\begin{itemize}
	    		...
	    		\item[] For one thing it is a collection of printable versions of Japanese zen sutras for tracing, chanting, learning or display in a variety of styles and fonts. See next page for examples.
	    	\end{itemize}
...
\end{quotation}
	...
	\begin{itemize}
		...
		\item[] \href{https://gwmatthews.github.io/leech-cards.pdf}{FLASHCARDS}
